            ...
            <div class="table-responsive">
                <table class="table" id="example">
                    ...
                    <div class="panel-body">
                        ...
                        <input type="text" class="form-control" name="nama_penumpang" value="{{$penumpang->nama_penumpang}}" readonly>
                    </div>
                    <div class="panel-body">
                    ...
                    <div class="panel-body">
                        ...
                        <input type="text" class="form-control" name="asal" value="{{$penumpang->asal}}" readonly>
                    </div>
                    <div class="panel-body">
                        <label>Tujuan Berangkat</label>
                        <input type="text" class="form-control" name="tujuan" value="{{$penumpang->tujuan}}" readonly>
                    </div>
                    <div class="panel-body">
                        <label>Kelas</label>
